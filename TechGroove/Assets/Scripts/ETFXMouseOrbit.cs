...
private bool startScript = false; //Starts the script after button press
public bool stopSpawning = false; //Allows explosions to keep spawning
...
private GameObject currentMagicCircle; // Keep track of the currently spawned MagicCircle
    ...
    void Start()
    {
        ...
        startScript = false; // Set this to true when the button is pressed
